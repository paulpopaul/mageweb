...
$(document).ready(function(){
	...
	*/
	jQuery('.song').on('mouseover', function(){
		jQuery(this).css('background-color', '#2AF598');
	...
	*/
	jQuery('.song').on('mouseout', function(){
		...
		jQuery(this).find('.song-meta-data .song-title').css('color', '#8388a1');
		jQuery(this).find('.song-meta-data .song-artist').css('color', '#000000');
		...
		jQuery(this).find('.song-duration').css('color', '#8388a1');
	});
